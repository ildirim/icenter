...
<div class="row">
	...
	<div class="panel-heading">
		...
		<div class="panel-options">
			...
			<!-- <a class="btn btn-default"  href="{{ route('headWsaAboutContext.index') }}" data-rel="reload"><i class="fa fa-align-center"></i> <b>Hamisi</b></a> -->
		</div>
	</div>
</div>
		...
		<div class="but_list">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				...
				<div id="myTabContent" class="tab-content">
					<form class="form-horizontal" action="{{ route('headWsaAboutContext.update', $headwsa->id) }}" method="post" enctype="multipart/form-data">
						<div class="tab-content">
							...
							<div class="tab-pane fade in @if($loop->iteration == 1) active @else  @endif" id="home{{$loop->iteration}}">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea name="content[{{$key}}]" class="form-control" rows="5">{{ $headwsa->translate($key)->content }}</textarea>
									</div>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								@if($headwsa->image)
								<a style="font-size: 16px" target="_blank" href="/storage/wsa/{{ $headwsa->image }}">{{ __('backend.show') }}</a>
								@endif
							</div>
						</div>
						<div class="form-group">
